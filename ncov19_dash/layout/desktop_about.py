    ...
    html.Div(
        [
            ...
            html.Div(
                [
                    html.Div(
                        "Sources: Center for Disease Control, Johns Hopkins Medicine, NC Department of Health and Human Services",
                        className="web-about-source",
                    ),
                ],
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    html.Div(
                                        "Han Lee",
                                        className="about-contributor-name",
                                    ),
                                    html.Div(
                                        " | Machine Learning Engineer",
                                        className="about-contributor-title",
                                    ),
                                ],
