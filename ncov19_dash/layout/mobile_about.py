            ...
            html.Div(
                [
                    html.H2(
                        ...
                        className="mob-about-page-title",
                    ),
                    html.Div(
                        [
                            html.Div(
                ...
                className="about-page-third",
                id="about-page-first-third",
            ),
            html.Div(
                [
                    html.Div(
                        "Sources: NC Department of Health and Human ",
                        className="about-source",
                    ),
                    html.Div(
                        "Services, Center for Disease Control, Johns Hopkins Medicine",
                        className="about-source-2",
                    ),
                ],
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/leehanchung",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/hanchunglee/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/hanchunglee",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                                [
                                    html.Div(
                                        "Han Lee",
                                        className="mob-about-contributor-name",
                                    ),
                                    html.Div(
                                        " | Machine Learning Engineer",
                                        className="mob-about-contributor-title",
                                    ),
                                ],
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/hurshd0",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/hurshd/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/elizabethts",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/elizabethts/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/elizabethets",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/Turtled",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/daniel-firpo/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/danielfirpo2",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/alex-pakalniskis",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/alexpakalniskis3/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/AlexPakalniskis",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/mchrupcala",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/michaelchrupcala/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/mikespellcheck",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/ars394",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/anishasunkerneni/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/youfoundanisha",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/dereketman",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/dereketman/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/DerekEtman",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://medium.com/@RK_yen",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/ryankyen/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/RK_yen",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/Scott-Huston",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/scott-huston-616512126/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/genuine_doubt",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/BuildABuddha",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/lawrence-kimsey/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/lawrence_kimsey",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
                    ...
                    html.Div(
                        [
                            html.A(
                                href="https://github.com/AceMouty",
                                target="_blank",
                                className="about-contributor-github-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://www.linkedin.com/in/acemouty/",
                                target="_blank",
                                className="about-contributor-linkedin-icon about-contributor-social-icon",
                            ),
                            html.A(
                                href="https://twitter.com/AceMouty",
                                target="_blank",
                                className="about-contributor-twitter-icon about-contributor-social-icon",
                            ),
                            html.Div(
