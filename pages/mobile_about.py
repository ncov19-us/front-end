    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                    ...
                    html.Div(" | Machine Learning Engineer", className="mob-about-contributor-title")
            ...
            html.Div([
                    html.Div("Derek Etman", className="mob-about-contributor-name"),
            ...
            html.Div([
                    html.Div("Ryan Yen", className="mob-about-contributor-name"),

                    html.Div(" | UI/UX Designer", className="mob-about-contributor-title")
                    ], className="about-page-contributors")
            ...
            html.Div([
                    html.Div("Scott Huston", className="mob-about-contributor-name"),
            ...
            html.Div([
                    html.Div("Lawrence Kimsey", className="mob-about-contributor-name"),
            ...
            html.Div([
                    html.Div("Kyle Guerrero", className="mob-about-contributor-name"),

                    html.Div(" | Full Stack Developer", className="mob-about-contributor-title")
                    ], className="about-page-contributors")
